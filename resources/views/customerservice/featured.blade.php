...
@section('title', 'All Featured Services | ')
			...
			<div class="col-xs-12">
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title"> All Featured Services </h3>
					...
					<div class="box-body">
						<div class="table-responsive">
                            <table class="display table table-bordered data_table_main">
                                ...
                                <tbody>
                                    @foreach($services as $key => $all_services)
                                        <tr id="curServiceDelete{{ $all_services->id }}">
                                            ...
                                            <td> {{ $all_services->featured_end_date }} </td>
