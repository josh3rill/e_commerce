...
<div class="content-wrapper" style="min-height: 518px;">
    ...
    <section class="content-header">
        <p id="referer_text" style="font-size: 21px">You can view all your requests in transit here.</p>
                ...
                <tbody>
                    @foreach($requests as $key=>$request)
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-warning float-ship-btn" data-toggle="modal" data-target="#launchMobileAgentModal">
