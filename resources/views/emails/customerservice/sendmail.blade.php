...
You are receiving this email because you have an EFContact account. <a style="text-decoration: none" href="{{ route('user.email.unsubscribe', ['email' => $email, 'subcriptionid' => $unique_identifier]) }}">Unsubscribe</a>
</div> --}}
@endcomponent
