    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            @else
                <img src="{{ '/uploads/users/'.Auth::guard('logistic')->user()->image  }}" class="user-image" alt="User Image">
            @endif --}}
        </a>
        <ul class="dropdown-menu scale-up">
         {{--  <!-- User image -->
          <li class="user-header" style="background-color: #f8d053;">
            <img src="{{ Auth::guard('logistic')->user()->image == null ? '/uploads/users/user-icon.png' : '/uploads/users/'.Auth::guard('agent')->user()->image  }}" class="img-responsive" alt="User Image">
