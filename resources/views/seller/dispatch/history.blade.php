...
@section('title', 'Dispatch Requests | ')
...
<div class="content-wrapper" style="min-height: 518px;">
    ...
    <section class="content-header">
        <h3 class="page-title">All Dispatch Request(s) </h3>
        <p class="page-description">This is a compiled list of all your dispatch request(s).</p>
    </section>
			...
			<div class="col-xs-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title"> All Dispatch Request(s) </h3>
                                ...
                                <tbody>
                                    @foreach($deliveries as $key => $delivery)
                                        <tr>
                                            ...
                                            <td>{{ $delivery->in_transit == 1 ? 'In transit' : 'With dispatch company' }} </td>
                                            <td>{{ $delivery->is_delivered == 1 ? 'Delivered' : 'Pending delivery' }} </td>
