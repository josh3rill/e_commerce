...
@section('title', 'Delivered Dispatch Requests | ')
...
<div class="content-wrapper" style="min-height: 518px;">
    ...
    <section class="content-header">
        <h3 class="page-title">Delivered Dispatch Request(s) </h3>
        <p class="page-description">This is a compiled list of all your delivered dispatch request(s).</p>
    </section>
			...
			<div class="col-xs-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title"> Delivered Dispatch Request(s) </h3>
