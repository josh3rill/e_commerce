...
@section('title', 'Pending Dispatch Requests | ')
...
<div class="content-wrapper" style="min-height: 518px;">
    ...
    <section class="content-header">
        <h3 class="page-title">Pending Dispatch Request(s) </h3>
        <p class="page-description">This is a compiled list of all your pending dispatch request(s).</p>
    </section>
			...
			<div class="col-xs-12">
				...
				<div class="box" >
					<div class="box-header">
						<h3 class="box-title"> Pending Dispatch Request(s) </h3>
                                ...
                                <tbody>
                                    @forelse($deliveries as $key => $delivery)
                                        <tr>
                                            ...
                                            <td><span class="text text-danger">With dispatch company</span> </td>
