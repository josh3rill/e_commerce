...
class ServiceController extends Controller
{
    ...
    public function index2(Request $request, $column = 'featured_end_date')
    {
       ...
       sin( radians( latitude ) ) )
            ...
            $view = view('welcome', compact([
                'featuredServices', 'recentServices',
                'approvedServices', 'user111', 'categories', 'search_form_categories', 'states', 'local_governments', 'sliders', 'trendingServices', 'hotServices', 'nearestServices', 'advertisements'
            ]))->render();
   ...
   sin( radians( latitude ) ) )
        ...
        return view('searchResult', compact([
            'featuredServices', 'all_states', 'services1', 'services2', 'services3', 'services4', 'services5', 'services5', 'services6', 'services7', 'services8',
...
if (count ( $seller ) > 0){
    ...
    public function searchOnServiceDetail(Request $request)
    {
        ...
        if ($user11 = Service::searchName($request->name)->searchState($request->state)->get()) {
